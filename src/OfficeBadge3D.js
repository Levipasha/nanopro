...
import officeBadgeUrl from './futuristic_blue_id_card_with_silhouette.glb';

function OfficeBadge3D() {
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (error) => {
        ...
        console.error('Error loading office badge model', error);
      }
    );
