...
import coffeeMenuUrl from './coffee_menu.glb';

function RestaurantBadge3D() {
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (error) => {
        ...
        console.error('Error loading restaurant badge model', error);
      }
    );
...
export default RestaurantBadge3D;
