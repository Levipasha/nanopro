...
import cardModelUrl from './card_06_aaaa_-_00.glb';

function CustomizeBadge3D() {
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (error) => {
        ...
        console.error('Error loading customize card model', error);
      }
    );
...
export default CustomizeBadge3D;
